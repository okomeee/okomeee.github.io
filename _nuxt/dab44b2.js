    ...
    231: function (e, t, n) {
      ...
      var a = (function (u) {
        ...
        function s(e, t) {
          ...
          return (
            ...
            (a.l = function () {
              var e = a.g,
                t = e.installing
              a.i > 0 || !i(t.scriptURL, a.m) || performance.now() > a.v + 6e4
                ? ((a.P = t), e.removeEventListener('updatefound', a.l))
                : ((a.p = t), a.h.add(t), a.o.resolve(t)),
                ++a.i,
                t.addEventListener('statechange', a.k)
            }),
            (a.k = function (e) {
              var t = a.g,
                n = e.target,
                ...
                r = n === a.P,
                u = r ? 'external' : '',
                o = { sw: n, originalEvent: e }
              !r && a.j && (o.isUpdate = !0),
                a.dispatchEvent(new v(u + i, o)),
                'installed' === i
                  ? (a.O = self.setTimeout(function () {
                      'installed' === i &&
                        t.waiting === n &&
                        a.dispatchEvent(new v(u + 'waiting', o))
                    }, 200))
                  : 'activating' === i &&
                    (clearTimeout(a.O), r || a.u.resolve(n))
            }),
            (a.R = function (e) {
              var t = a.p
            ...
            (a.S =
              ((n = function (e) {
                var t = e.data,
                  n = e.source
                return f(a.getSW(), function () {
                  a.h.has(n) &&
                    a.dispatchEvent(
                      new v('message', { data: t, sw: n, originalEvent: e })
                    )
                })
              }),
              function () {
            ...
            (a.m = e),
            (a.t = t),
            navigator.serviceWorker.addEventListener('message', a.S),
            a
          )
        }
        ;(e = u),
          ((a = s).prototype = Object.create(e.prototype)),
        ...
        return (
          (l.register = function (e) {
            ...
            try {
              ...
              return (function (e, t) {
                ...
                function () {
                  return (
                    (u.j = Boolean(navigator.serviceWorker.controller)),
                    (u.U = u.B()),
                    f(u.L(), function (e) {
                      ;(u.g = e),
                        u.U &&
                          ...
                          u.u.resolve(u.U),
                          u.s.resolve(u.U),
                          u.U.addEventListener('statechange', u.k, {
                            once: !0,
                          }))
                      var t = u.g.waiting
                      return (
                        t &&
                          ...
                          Promise.resolve()
                            ...
                            .then(function () {})),
                        u.p && (u.o.resolve(u.p), u.h.add(u.p)),
                        u.g.addEventListener('updatefound', u.l),
          ...
          (l.update = function () {
            try {
              return this.g ? h(this.g.update()) : void 0
            } catch (e) {
              return Promise.reject(e)
            }
          }),
          ...
          (l.L = function () {
            try {
              ...
              return (function (e, t) {
                ...
                function () {
                  return f(
                    navigator.serviceWorker.register(e.m, e.t),
                    function (t) {
