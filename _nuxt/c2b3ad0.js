  ...
  [0],
  {
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 52:
                          ...
                          if (
                            'function' == typeof (R = E.value).options.validate
                          ) {
                            t.next = 56
                            break
                          }
                ...
                return regeneratorRuntime.wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 23:
                        P.call(n, w.currentRoute, w.currentRoute, function (
                          path
                        ) {
                          if (path) {
    ...
    35: function (t, e, n) {
      ...
      var j = {
        ...
        P = (n(19), n(20), n(10), n(29)),
        A = {
          name: 'Nuxt',
          components: { NuxtChild: j, NuxtError: S },
          props: {
        ...
        D =
          (n(189),
          Object(R.a)(T, void 0, void 0, !1, null, null, null).exports),
        N =
          (n(191),
          n(193),
          n(195),
      ...
      })(n(199), 'store/index.js')).modules = U.modules || {}
      var B =
        U instanceof Function
          ? U
          : function () {
              return new f.a.Store(Object.assign({ strict: !1 }, U))
            }
      var z = n(111),
        K = n.n(z),
        H = function (t, e) {
      ...
      function wt(path, t) {
        ...
        return yt.call(this, path, t, xt(xt({}, bt), e))
      }
      function _t(t) {
        return $t.apply(this, arguments)
      }
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                      ...
                      (f = xt(
                        {
                          head: {
                            ...
                            link: [
                              ...
                              {
                                rel: 'manifest',
                                href: '/_nuxt/manifest.125d3c40.json',
                              },
                              {
                                rel: 'shortcut icon',
                  ...
                  case 14:
                    ...
                    return (t.next = 20), K()(f.context, d)
                  case 20:
                    return (t.next = 23), H(f.context, d)
                  case 23:
                    t.next = 26
                    break
                  case 26:
